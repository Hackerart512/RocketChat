        ...
        <>
            <section className="login-section flex items-center justify-center flex-col">
                ...
                <div className="flex items-center justify-center flex-col my-4">
                    ...
                    <p className='text-[20px] text-[#7a7f9a] mt-2'>Sign in to continue to Chatvia.</p>
                ...
                <div className="my-5">
                    ...
                    <p className='text-[20px]   mt-2'>Don't have an account ? Signup now</p>

                    <p className='text-[20px]   mt-4'>© 2024 Chatvia. Crafted with <i className='fa fa-heart text-[red]'></i> by Themesbrand</p>
                </div>
